...
namespace useful
{
	...
	public class qpctimer
	{
		...
		private long				m_last_counter;						// GetElapsedTime()用前回のカウント値
		private long				m_section_start_counter;			// 

		private long				m_qpf_ticks_per_sec;				// 1秒間に増えるカウンタ
		private float				m_inv_qpf_ticks_per_sec;			// 1秒間に増えるカウンタの逆数
