...
namespace Utility
{
    ...
    static public class Useful
    {
        ...
        /// メイリオがインストールされていない場合はなにもしない
        /// </summary>
        /// <param name="form">対象のコントロール</param>
        /// <param name="point">フォントサイズ</param>
        ...
        /// 変換に실패した場合はnew DateTime()を返す. 
        /// </summary>
        /// <param name="datetime">変換対象の文字列</param>
        ...
        /// 読み込みに실패したAssemblyNameを返す. 
        /// 読み込みに成功した場合はnullを返す. 
        /// </summary>
        /// <param name="ass">アセンブリ명</param>
        /// <param name="error_ass">読み込みに실패したアセンブリ</param>
        ...
        /// STDOUTの내용を返す. 
        /// </summary>
        /// <param name="Argments">コマンドと引数</param>
        ...
        /// 変換に실패した場合nullを返す. 
        /// </summary>
        /// <param name="enumType">Enumのタイプ typeof(enum)</param>
        /// <param name="value">変換対象</param>
        /// <returns>変換後のEnum</returns>
        ...
        /// <param name="tooltip">対象のToolTip</param>
        ...
        /// </summary>
        /// <param name="_from">変換対象の文字列</param>
        ...
        /// 실패した場合はdefalt_valueを返す
        /// </summary>
        /// <param name="x">変換対象の文字列x</param>
        /// <param name="y">変換対象の文字列y</param>
        /// <param name="defalte_value">실패時に返す値</param>
        /// <returns>変換後の値</returns>
