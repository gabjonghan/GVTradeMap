...
namespace gvtrademap_cs
{
	...
	class setting_window : d3d_windows.window
	{
		...
		private string get_tooltip_string_setting(Point pos)
		{
			...
			string	tip;
			switch(index){
			case setting_icons_index.save_searoutes:		tip	= "항로기록（要측량）"; break;
			case setting_icons_index.share_routes:			tip	= "공유している배표시（要설정）"; break;
			case setting_icons_index.web_icons:				tip	= "@Web아이콘표시\n우클릭で표시항목설정"; break;
			case setting_icons_index.memo_icons:			tip	= "메모아이콘표시\n우클릭で표시항목설정"; break;
