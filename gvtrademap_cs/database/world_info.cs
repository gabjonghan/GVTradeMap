...
namespace gvtrademap_cs
{
        ...
        private static EnumParser<GvoWorldInfo.CulturalSphere>[] m_culturalsphere_enum_param = new EnumParser<GvoWorldInfo.CulturalSphere>[29]
    {
      ...
      new EnumParser<GvoWorldInfo.CulturalSphere>(GvoWorldInfo.CulturalSphere.NorthAmerica, "북미")
    };
        ...
        private hittest_list m_nonseas;             // 해역以外の목록
        ...
        public class Info : hittest, IDictionaryNode<string>
        {
            ...
            private string[] m_memo_div_lines;  // 行単位に분割された메모
            ...
            private List<Group> m_groups;       // group_index분のデータ
            ...
            public class Group
            {
                ...
                public class Data
                {
                    ...
                    // 外からの参照用
                    private bool m_is_bonus_item;       // 명産品
                    private string m_price;             // 가격, 인물명など
                    private Color m_color;              // 표시色
                    private Color m_price_color;            // 가격用色
                    private string m_investment;            // 必要な가격額
                    private ItemDatabaseCustom.Data m_item_db;              // 아이템DBの詳細
...
//						}
        ...
        {
            private string m_name;              // 이름
            private GvoWorldInfo.Country[] m_domains;           // 동맹状況
    ...
    {
        private MultiDictionary<string, ItemRank> m_bonus_items;            // 명産品扱いの아이템
        private MultiDictionary<string, ItemRank> m_nanban_trade_items; // 남만品扱いの아이템
        ...
        public void Load()
        {
            ...
            {
                Console.WriteLine("採取ランク등の読み込みで問題発生");
