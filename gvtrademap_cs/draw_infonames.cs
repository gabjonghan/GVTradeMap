...
namespace gvtrademap_cs
{
	...
	class draw_infonames : IDisposable
	{
		...
		private d3d_writable_vb_with_index		m_icons1_vb;			// 대 아이콘用
		private d3d_writable_vb_with_index		m_city_names1_vb;		// 도시명과 상륙지점명
		private d3d_writable_vb_with_index		m_icons2_vb;			// 소 아이콘用
