namespace gvtrademap_cs
{
	partial class sea_routes_form2
	{
		...
		private void InitializeComponent()
		{
            ...
            this.tabPage1.ToolTipText = "통상の항로도목록です. 설정항목の保持数설정を超えると古い항로도から自動で과거의항로도に이동されます. ";
            ...
            this.tabPage2.ToolTipText = "즐겨찾기の항로도を登録します. 自動では삭제されません. ";
            // 
            // tabPage3
            // 
            ...
            this.tabPage3.ToolTipText = "과거의항로도は목록표시のみで그리기されません. 그리기されないため, CPU負荷が軽くたくさんの항로도を保持しておけます. ";
            // 
            // label1
            // 
