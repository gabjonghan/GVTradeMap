...
namespace gvtrademap_cs {
	public class nameTexture : d3d_sprite_rects {
		private const int CITY_START_INDEX = 0;

		/*-------------------------------------------------------------------------

		---------------------------------------------------------------------------*/
		public nameTexture(d3d_device device, string infoimage_fname)
		...
		private void add_rects() {
			...
			AddRect(new Vector2(-27, -14), new Rectangle(200, 704, 84, 15));	// 172 중경
			...
			AddRect(new Vector2(-15, -2), new Rectangle(300, 940, 318 - 288, 960 - 940));   // 91 파나마 북동 파나마北東
